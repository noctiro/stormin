...
const COMMON_SURNAMES: &[&str] = &[
    "zhang", "li", "wang", "zhao", "liu", "chen", "yang", "huang", "wu", "xu", "sun", "zhou",
    "gao", "lin", "he", "ma", "luo", "zheng", "xie", "ye", "xu", "jiang", "tang", "liu", "xu",
    "shen", "wu", "xu", "song", "wei", "pu", "xie", "zhu", "peng", "zhang", "yuan", "wu", "pan",
    "zhuang",
];
